"use strict";
(wx["webpackJsonp"] = wx["webpackJsonp"] || []).push([["vendors-node_modules_taro_weapp_prebundle_vuex_js"],{

/***/ "./node_modules/.taro/weapp/prebundle/vuex.js":
/*!****************************************************!*\
  !*** ./node_modules/.taro/weapp/prebundle/vuex.js ***!
  \****************************************************/
...
/* harmony export */   "default": function() { return /* binding */ vuex_default; },
...
/* provided dependency */ var navigator = __webpack_require__(/*! ./node_modules/.taro/weapp/prebundle/chunk-TPMSBFWW.js */ "./node_modules/.taro/weapp/prebundle/chunk-TPMSBFWW.js")["nav"];
...
function resetStoreState(store, state, hot) {
    ...
    var computedObj = {};
    var computedCache = {};
    var scope = (0, import_vue.effectScope)(true);
    scope.run(function() {
        forEachValue(wrappedGetters, function(fn, key) {
            computedObj[key] = partial(fn, store);
            computedCache[key] = (0, import_vue.computed)(function() {
    ...
    normalizeMap(mutations).forEach(function(ref) {
        ...
        res[key] = function mappedMutation() {
            ...
            return typeof val === "function" ? val.apply(this, [
                commit2
            ].concat(args)) : commit2.apply(this.$store, [
                val
            ].concat(args));
        };
    });
...
var mapActions = normalizeNamespace(function(namespace, actions) {
    ...
    normalizeMap(actions).forEach(function(ref) {
        ...
        res[key] = function mappedAction() {
            ...
            return typeof val === "function" ? val.apply(this, [
                dispatch2
            ].concat(args)) : dispatch2.apply(this.$store, [
                val
            ].concat(args));
        };
    });
